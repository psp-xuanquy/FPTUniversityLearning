...
delegate void Say();      //   biến để nói về hàm nào đó cụ thể
                          ...
                          //-> biến Say() f = SayHello() (f là hàm có style void và cụ thể là hàm SayHello())
...
//KIỂU DỮ LIỆU DÙNG ĐỂ ĐẶT/GỌI TÊN CHO CÁC VALUE THUỘC STYLE/FORMAT/DỊNH DẠNG NÀO ĐÓ
...
//Bản chất Delegate chính là 1 class mà chỉ tập trung vào việc lưu trữ thông tin của các hàm cùng style nằm rải rác
...
internal class Program
{
    ...
    public static void SayHelloDoctor() => Console.WriteLine("Hello Doctor, C# is so tired");   //expression body
