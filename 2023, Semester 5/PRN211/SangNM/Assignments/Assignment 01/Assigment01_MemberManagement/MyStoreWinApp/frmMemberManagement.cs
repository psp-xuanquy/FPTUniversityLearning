...
namespace MyStoreWinApp
{
    public partial class frmMemberManagement : Form
    {
        ...
        private MemberObject GetMemberInfo()
        {
            ...
            {
                MessageBox.Show(ex.Message, "Get Member Infomtion", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            return member;
        }
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                if (MessageBox.Show($"Do you really want to delete this member: \n" +
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (radioByID.Checked)
                {
                    ...
                    IEnumerable<MemberObject> searchResult = memberRepository.SearchMemberByID(searchID);
                    if (searchResult.Any())
                    {
                ...
                else if (radioByName.Checked)
                {
                    ...
                    IEnumerable<MemberObject> searchResult = memberRepository.SearchMemberByName(searchName);
                    if (searchResult.Any())
                    {
                        dataSource = searchResult;
                        this.searchResult = searchResult;
