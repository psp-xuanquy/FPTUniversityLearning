...
import { getInfoAdmin as queryCurrentUser } from './services/api/administratorController';
...
export async function getInitialState(): Promise<{
  ...
  currentUser?: API.GetInfoAdminResponse;
  timeExam?: number;
  isSubmitExam?: boolean;
  loading?: boolean;
  fetchUserInfo?: () => Promise<API.GetInfoAdminResponse | undefined>;
}> {
...
export const layout: RunTimeLayoutConfig = ({ initialState, setInitialState }) => {
  return {
    ...
    waterMarkProps: {
      content: `${initialState?.currentUser?.administrator?.fullName}`,
    },
    // footerRender: () => <Footer />,
    onPageChange: () => {
      const { location } = history;
