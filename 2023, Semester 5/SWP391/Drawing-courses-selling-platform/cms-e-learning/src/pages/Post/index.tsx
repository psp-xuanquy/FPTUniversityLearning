...
import { getInfoListWithFilterPaging2 } from '@/services/api/PORTALForumPostController';
import { getDetailById } from '@/services/api/PORTALForumTopicController';
import { ClockCircleOutlined, UserOutlined } from '@ant-design/icons';
import { useParams } from '@umijs/max';
import { Divider, Empty, Pagination, PaginationProps } from 'antd';
...
export default (): JSX.Element => {
  ...
  useEffect(() => {
    if (topicId) {
      getInfoListWithFilterPaging2({ topicId: topicId, page: current - 1, size: PAGE_SIZE }).then(
        (res) => {
          setPost(res.data || {});
        },
      );
